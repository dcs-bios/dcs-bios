...
definePushButton("NAV_SELECT_BTN_L_MAL", 12, 3008, 281, "Navigation", "Navigation Selector Button L MÅL")
...
defineToggleSwitch("HOJD_CISI", 22, 3200, 324, "Flight Data Unit", "HÖJD CISI")
...
defineIndicatorLight("BRÄ UPPF", 408, "Error Panel", "Fuel Distribution Low Pressure")
defineIndicatorLight("X-TANK BRÄ", 409, "Error Panel", "External Fuel Tank Feed System")
...
defineIndicatorLight("TÄNDSYST", 431, "Error Panel", "Ignition System")
...
defineIndicatorLight("BRÄ_24", 435, "Error Panel", "Low Fuel")
